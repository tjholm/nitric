...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "applicationClientId", GoGetter: "ApplicationClientId"},
			...
			_jsii_.MemberProperty{JsiiProperty: "containerAppOutput", GoGetter: "ContainerAppOutput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "hostUrlOutput", GoGetter: "HostUrlOutput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "servicePrincipalClientIdOutput", GoGetter: "ServicePrincipalClientIdOutput"},
			_jsii_.MemberProperty{JsiiProperty: "servicePrincipalTenantIdOutput", GoGetter: "ServicePrincipalTenantIdOutput"},
